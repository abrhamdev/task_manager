  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-10">
      <div ref={ref} className="container grid max-w-screen-lg gap-8 lg:grid-cols-2 lg:grid-rows-2">
        <motion.div initial={{scale:0.7}} animate={isInview?{scale:1}:{}} transition={{ type: "spring", stiffness:30,}} className="row-span-2 flex flex-col rounded-md bg-gray-800/50 border border-gray-700/50 backdrop-blur-sm">
          ...
          <div className="p-10">
            ...
            <a href="" className="mt-2 inline-flex text-sky-300">
              Learn More →
            </a>
          </div>
        </motion.div>
        <motion.div initial={{scale:0.7}} animate={isInview?{scale:1}:{}} transition={{ type: "spring", stiffness: 30,}} className="flex rounded-md bg-gray-800/50 border border-gray-700/50 backdrop-blur-sm">
