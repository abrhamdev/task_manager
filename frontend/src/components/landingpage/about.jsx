      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-lg p-6 rounded-lg">
            <div className="flex items-center justify-center h-16 w-16 mx-auto mb-4 bg-blue-100 text-blue-600 rounded-full">
              {/* Icon */}
              <DocumentTextIcon />
            </div>
          ...
          {/* Block 3 */}
          <div className="bg-white shadow-lg p-6 rounded-lg">
            <div className="flex items-center justify-center h-16 w-16 mx-auto mb-4 bg-purple-100 text-purple-600 rounded-full">
              {/* Icon */}
              <UsersIcon />
            </div>
            <h3 className="text-lg font-semibold text-gray-800 mb-2">
